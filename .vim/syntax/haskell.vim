...
"     syn match  hsSpecialChar	contained
"     "\\\(NUL\|SOH\|STX\|ETX\|EOT\|EN<q>\|ACK\|BEL\|BS\|HT\|LF\|VT\|FF\|CR\|SO\|SI\|DLE\|DC1\|DC2\|DC3\|DC4\|NAK\|SYN\|ETB\|CAN\|EM\|SUB\|ESC\|FS\|GS\|RS\|US\|SP\|DEL\)"
"     syn match  hsSpecialCharError contained "\\&\y region  hsString
"     start=+"+  skip=+\\\\\|\\"+  end=+"+  contains=hsSpecialChar,@Spell
"     sy match   hsCharacter
"     "[^a-zA-Z0-9_']'\([^\\]\|\\[^']\+\|\\'\)'"lc=1
"     contains=hsSpecialChar,hsSpecialCharError
"     sy match   hsCharacter	    "^'\([^\\]\|\\[^']\+\|\\'\)'"
"     contains=hsSpecialChar,hsSpecialCharError
"
"     " (<q>ualified) identifiers (no default highlighting)
"     syn match ConId "\(\<[A-Z][a-zA-Z0-9_']*\.\)\=\<[A-Z][a-zA-Z0-9_']*\>"
"     syn match VarId "\(\<[A-Z][a-zA-Z0-9_']*\.\)\=\<[a-z][a-zA-Z0-9_']*\>"
"
"     " Infix operators--most punctuation characters and any (qualified)
"     identifier
"     " enclosed in `backquotes`. An operator starting with : is a
"     constructor,
...
"
"     sy region hsInnerParen start="(" end=")" contained
"     contains=hsInnerParen,hsConSym,hsType,hsVarSym
"     sy region hs_InfixOpFunctionName start="^("
"     end=")\s*[^:`]\(\W\&\S\&[^'\"`()[\]{}@]\)\+"re=s
...
"
"                     sy keyword hsStructure data family class where instance
"                     default deriving
...
"                       " Primitive types from the standard prelude and
"                       libraries.
...
"                               endif
"
"                               syn region  hsPackageString start=+L\="+
"                               skip=+\\\\\|\\"\|\\$+ excludenl end=+"+
"                               end='$' contains=cSpecial contained
"                               sy match   hsModuleName  excludenl
"                               "\([A-Z]\w*\.\?\)*" contained 
"
"                               sy match hsImport
...
"                                       \
"                                       nextgroup=hsImportParams,hsImportIllegal
"                                       skipwhite
"                                       sy keyword hsImportLabel import
"                                       qualified contained
"
"                                       sy match hsImportIllegal "\w\+"
"                                       contained
"
"                                       sy keyword hsAsLabel as contained
"                                       sy keyword hsHidingLabel hiding
"                                       contained
"
"                                       sy match hsImportParams
"                                       "as\s\+\(\w\+\)" contained
...
"                                                       contained
"                                                           \
"                                                           contains=hsBlockComment,hsLineComment,
"                                                           hsType,hsDelimTypeExport,hs_hlFunctionName,hs_OpFunctionName
"                                                               \
"                                                               nextgroup=hsImportIllegal
"                                                               skipwhite
"
"                                                               " hi hsImport
"                                                               guibg=red
...
"                                                               contained
"                                                               keepend extend
"                                                               contains=hs_OpFunctionName
"                                                               "sy region
"                                                               hsImportList
"                                                               matchgroup=hsImportListParens
"                                                               start="("rs=s+1
"                                                               end=")"re=e-1
"                                                               "        \
"                                                               contained 
...
"                                                                  "\<module\>\(\s\|\t\|\n\)*\([A-Z]\w*\.\?\)*"
"                                                                  contained
"                                                                  contains=hsExportModuleLabel,hsModuleName
"
"                                                                  sy keyword
"                                                                  hsModuleStartLabel
"                                                                  module
...
"                                                                      end="-}"
"                                                                        \
"                                                                        contains=hsModuleCommentA,hsCommentTodo,@Spell
"                                                                        contained
"                                                                          \
"                                                                          nextgroup=hsModuleCommentA,hsModuleExports,hsModuleWhereLabel
"                                                                          skipwhite
...
"                                                                              contained
"                                                                                 \
"                                                                                 nextgroup=hsModuleCommentB,hsModuleWhereLabel
"                                                                                 skipwhite
"                                                                                 skipnl
"                                                                                    \
...
"                                                                                        end="-}"
"                                                                                           \
"                                                                                           contains=hsModuleCommentB,hsCommentTodo,@Spell
"                                                                                           contained
"                                                                                              \
"                                                                                              nextgroup=hsModuleCommentB,hsModuleWhereLabel
"                                                                                              skipwhite
...
"                                                                                                  start="{-"
"                                                                                                  end="-}"
"                                                                                                  contains=hsBlockComment,hsCommentTodo,@Spell
"                                                                                                  sy
"                                                                                                  region
"                                                                                                  hsPragma
"                                                                                                  start="{-#"
...
"                                                                                                  end="|\]"me=e-2
"                                                                                                  keepend
"                                                                                                  contains=hs<q><q>VarID,hs<q><q>Content
"                                                                                                  nextgroup=hs<q><q>End
"                                                                                                  sy
"                                                                                                  region
"                                                                                                  hs<q><q>New
"                                                                                                  start="\[\(.\&[^|]\&\S\)*|"
"                                                                                                  end="|\]"me=e-2
"                                                                                                  keepend
"                                                                                                  contains=hs<q><q>VarIDNew,hs<q><q>Content
"                                                                                                  nextgroup=hs<q><q>End
"                                                                                                  sy
"                                                                                                  match
"                                                                                                  hs<q><q>Content
...
"                                                                                                          region
"                                                                                                          cPreCondit
"                                                                                                          start="^\s*\(%:\|#\)\s*\(if\|ifdef\|ifndef\|elif\)\>"
"                                                                                                          skip="\\$"
"                                                                                                          end="$"
"                                                                                                          end="//"me=s-1
"                                                                                                          contains=cComment,cCppString,cCommentError
"                                                                                                          syn
"                                                                                                          match
"                                                                                                          cPreCondit
"                                                                                                          display
...
"                                                                                                          end="^\s*\(%:\|#\)\s*\(endif\>\|else\>\|elif\>\)"
    ...
    "                                                                                                          start="/\*"
    "                                                                                                          end="\*/"
    "                                                                                                          contains=cCommentStartError,cSpaceError
    "                                                                                                          contained
    "                                                                                                          syntax
    "                                                                                                          match
    "                                                                                                          cCommentError
    ...
    "                                                                                                                                          hsOperator
    "                                                                                                                                            if
    "                                                                                                                                            exists("hs_highlight_delimiters")
    "                                                                                                                                                "
    "                                                                                                                                                Some
    "                                                                                                                                                people
    "                                                                                                                                                find
